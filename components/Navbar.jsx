      ...
      {session?.user ? (
        <div className="flex flex-col">
          <div className="profile flex flex-col items-center gap-2 pb-6">
            ...
            <div className="pt-1">
              <p className="font-bold text-[9px] lg:text-xs text-white">
                {session?.user.name}
              </p>
              <p className=" text-[9px] lg:text-xs text-[#EBEBF5]">
                {session?.user.email}
              </p>
            </div>
          </div>
          <Link
            href="/"
            className="flex items-center gap-2 cursor-pointer hover:bg-gradient-to-b from-[#FF4742] from-[-100%] p-1 py-4 rounded text-[#BFBFBF] border-t-2 border-[#2C2F35]  hover:border-[#FF4742] transition-colors text-[12px] md:text-base"
          >
            <BiHome /> Home
          </Link>
          <Link
